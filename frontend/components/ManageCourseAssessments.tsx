...
const ManageCourseAssessments: React.FC<ManageCourseAssessmentsProps> = ({ course }) => {
  ...
  if (!data) return <div>Loading assessments...</div>;
  ...
  const canManage = currentUser?.role === 'Teacher' || isCoordinator;

  const handleDeleteAssessment = (assessmentId: string) => {
    if (window.confirm("Are you sure you want to delete this assessment and all its questions and marks? This action cannot be undone.") && setData) {
