...
import AssessmentReportsList from './AssessmentReportsList';

type Tab = 'Overview' | 'COs' | 'Assessments' | 'CO-PO Mapping' | 'Student Reports' | 'Faculty Assignment' | 'Assessment Reports';
